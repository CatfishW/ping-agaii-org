...
def get_game_detail(slug: str) -> dict | None:
    details = {
        "meeting-cells": {
            "name": "Meeting Cells",
            "slug": "meeting-cells",
            "description": "Begin your journey into the bloodstream! Meet the different types of blood cells.",
            "category": "biology",
            "difficulty": "easy",
            "estimatedTime": 20,
            "gradeLevel": ["5", "6", "7", "8"],
            ...
            "learningObjectives": [
                ...
                "Understand the function of red blood cells",
                "Learn about white blood cells and immunity",
                "Discover how platelets help with healing",
            ],
        ...
        "thumping-heart": {
            "name": "Thumping Heart",
            "slug": "thumping-heart",
            "description": "Enter the powerful heart and feel its rhythm!",
            "category": "biology",
            "difficulty": "medium",
            "estimatedTime": 25,
            "gradeLevel": ["6", "7", "8", "9"],
            ...
            "learningObjectives": [
                ...
                "Learn how valves control blood flow",
                "Explore the cardiac cycle",
            ],
            "statistics": {"totalPlays": 0, "averageScore": 0},
        },
        "need-for-speed": {
            "name": "Need for Speed & Oxygen",
            "slug": "need-for-speed",
            "description": "Race through the circulatory system!",
            "category": "biology",
            "difficulty": "medium",
            "estimatedTime": 30,
            "gradeLevel": ["6", "7", "8", "9"],
            "gameUrl": "https://game.agaii.org/Force&Motion",
            "learningObjectives": [
                "Understand blood pressure and flow dynamics",
                "Learn how mass can affect speed",
                "Discover how oxygen binds to hemoglobin",
            ],
            "statistics": {"totalPlays": 0, "averageScore": 0},
        },
    }
